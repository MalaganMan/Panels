...
- UPDATE 2026 August 9th: Insert FX 2 until Auto Pan works outside now. Loading should work with CtrlrX.org Uninitalized variable crashing panel fixed. VST Problem fixed leaving FX_table to be created by button.