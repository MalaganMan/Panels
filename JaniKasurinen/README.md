...
- 2024 August 1st: Major updates and propably the final version for a long time =D
- Patch lists can now be read from bank dumps and all the patches seen at once.
