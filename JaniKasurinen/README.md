...
- UPDATE 2024 October 2st: Device_ID now changed for sysex dumps and checked on receive to match. Confusion still possible with MIDI out an in channels. Uploaded text files of preset and internal banks for EX5R named Preset Bank 1/2 and Internal Bank 1/2.txt
